...
3.  **Configure Environment Variables:**
    ...
    ```env
    PORT=3001
    SEPOLIA_RPC_URL=https://eth-sepolia.g.alchemy.com/v2/slDhTW4pqYerfxqdQWxVc
    SEPOLIA_PRIVATE_KEY=59734912447fce00975e761fcbfc89ffecffc0ff7c7c43a16b549bb6ea4e1a8a
    CONTRACT_ADDRESS=0x3ccCB69D0f3317847Ada0AE42a36B3414FDB3d9a
    MONGODB_URI=mongodb+srv://ojoinioluwa05:owobCi68qHHWKbQG@oay.vupnvf7.mongodb.net/sentinel_aml
    JWT_SECRET=ojay123
